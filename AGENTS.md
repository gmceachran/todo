...
- `mockups/board.html` and `board.bundle.js` are generated by `mockups/build.sh` from the live app (`index.html`, the root modules, forced into demo mode) so the board opens from `file://`. Don't edit them by hand; rerun the script after UI changes.
